...
export const StaffDashboardScreen: React.FC = () => {
  return (
    <div className="bg-background text-on-background font-body min-h-[100dvh] pb-52 w-full relative overflow-y-auto hide-scrollbar">
      <main className="px-6 space-y-6 max-w-5xl mx-auto pt-4 relative">
      ...
      {/* FAB */}
      <button className="fixed bottom-32 right-8 w-16 h-16 bg-primary text-on-primary rounded-full shadow-[0_8px_30px_rgb(0,30,64,0.4)] backdrop-blur-sm flex items-center justify-center active:scale-95 transition-all z-50 border-2 border-white/10">
