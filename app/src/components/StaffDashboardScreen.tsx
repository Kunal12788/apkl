          ...
          <div className="luxury-card divide-y divide-surface-container overflow-hidden">
            {recentTasks.length === 0 ? (
              ...
              recentTasks.map((task) => {
                ...
                return (
                  <div key={task.id} className={`p-4 flex items-center justify-between transition-colors ${isCash ? 'cash-watermark-row hover:bg-surface-bright bg-white' : 'hover:bg-surface-bright bg-white'}`}>
                    <div className="flex items-center gap-3">
