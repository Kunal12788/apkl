...
export const SuperAdminDashboardScreen: React.FC = () => {
  ...
  const quickActions = [
    ...
    { id: 'customer', name: 'Customer', desc: 'Client Directory', icon: 'groups', color: 'text-secondary', grad: 'from-secondary/10 to-secondary/[0.02]', border: 'border-secondary/20', glow: 'group-hover:shadow-[0_0_15px_rgba(0,89,187,0.2)]', action: () => navigate('/customers') },
